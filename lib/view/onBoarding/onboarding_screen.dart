...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  int _currentPage = 0;
  List colors = const [
    Color.fromARGB(255, 223, 233, 240),
    Color.fromARGB(255, 222, 242, 255),
    Color.fromARGB(255, 220, 233, 246),
  ];
                  ...
                  _currentPage + 1 == contents.length
                      ? Padding(
                          ...
                          child: ElevatedButton(
                            onPressed: () async {
                              await _completeOnboarding(); // Save onboarding completion status
                              Get.offAndToNamed(Routes
                                  .CHOOSEACCOUNT); // Navigate to the next screen
                            },
                            child: Text(
                              "إبدأ",
  ...
  Future<void> _completeOnboarding() async {
    ...
    await Get.find<SharedPreferences>().setBool(AppConstants.ONBOARDING_COMPLETE, true);
  }
}
