...
class CustomerInvoiceReportPrint {
  StoreGetModel? store;
...
Page _createPage(var image) {
            ...
            Row(
              ...
              children: [
                Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(store!.name.toString(), style: TextStyle(fontSize: 20)),
                  ],
                ),
                Text("تقرير تفصيلي", style: TextStyle(fontSize: 30)),
                Image(image, width: 120, height: 120),
              ],
            ),
            SizedBox(height: 3),
            Text("صاحب الحساب: ${customer!.cuName}   ", style: TextStyle(fontSize: 20)),
            Text("رقم الهاتف: ${customer!.userPhoneNo}", style: TextStyle(fontSize: 20)),
            SizedBox(height: 3),
            Row(
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                SizedBox(width: 210),
                Text("من تاريخ: ${fromDate!.day}/${fromDate!.month}/${fromDate!.year}", style: TextStyle(fontSize: 16)),
                SizedBox(width: 80),
                Text("إلى تاريخ: ${toDate!.day}/${toDate!.month}/${toDate!.year}", style: TextStyle(fontSize: 16)),
              ],
            ),
            SizedBox(height: 3),
            Table(
              ...
              children: [
                  ...
                  children: [
                    for (var header in [
                      ...
                      Container(
                        ...
                        child: Text(header, style: TextStyle(fontSize: 10)),
                      ),
                  ],
                ),
                  ...
                  TableRow(
                    children: [
                      Container(
                        ...
                        alignment: Alignment.center,
                        child: Text(
                          invoiceItems![i].participantName == "0" ? customer!.cuName : invoiceItems![i].participantName,
                      ...
                      Container(
                        ...
                        alignment: Alignment.center,
                        child: Text(
                          (invoiceItems![i].quantity * invoiceItems![i].unitPrice).toString(),
                          style: TextStyle(fontSize: 9),
                        ),
                      ),
                      Container(
                      ...
                      Container(
                        ...
                        alignment: Alignment.center,
                        child: Text(
                          invoiceItems![i].quantity.toString(),
                          style: TextStyle(fontSize: 9),
                        ),
                      ),
                      Container(
                      ...
                      Container(
                        ...
                        alignment: Alignment.center,
                        child: Text(
                          "${DateTime.parse(invoiceItems![i].enteredDate).day.toString()}/${DateTime.parse(invoiceItems![i].enteredDate).month.toString()}/${DateTime.parse(invoiceItems![i].enteredDate).year.toString()}",
                          style: TextStyle(fontSize: 9),
                        ),
                      ),
                      Container(
                ...
                // Add a row to display the total sum
                TableRow(
                  children: [
                    for (var j = 0; j < 6; j++)
                      Container(),
                    Container(
                      ...
                      alignment: Alignment.center,
                      child: Text(
                        "المجموع: ${calculateTotal(invoiceItems!)}", // You need to define the calculateTotal function
 ...
 // Define the function to calculate the total sum
double calculateTotal(List<InvoiceGetDto> items) {
  double total = 0.0;
