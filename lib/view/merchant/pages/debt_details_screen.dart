...
class DebtDetailsScreen extends GetView<DebtDetailsController> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: "تقارير عميل "),
                ...
                Container(
                  ...
                  child: Obx(() => controller.isInvoiceReport.value == true
                      ? Column(
                          children: [
                            tableHeader(),
                            GetBuilder<DebtDetailsController>(
                              builder: (context) {
                                if (controller.invoiceItems == null) {
                                  ...
                                  return Column(
                                    children:
                                      ...
                                      return tableRow(element, controller);
                                    }).toList(),
                                  );
                                }
                              },
                                ...
                                if (controller.transactions == null) {
                                  ...
                                  return Column(
                                    children:
                                      ...
                                      return _tableRowForTransaction(
                                          element, controller);
                                    }).toList(),
                                  );
                                }
...
Widget _tableHeaderForTransaction() {
  return Container(
    padding: const EdgeInsets.symmetric(vertical: 12, horizontal: 16),
    color: Colors.grey.shade200,
    child: Row(
...
// Table Row
Widget tableRow(InvoiceGetDto invoiceGetDto, DebtDetailsController controller) {
...
// Table Row
Widget _tableRowForTransaction(
    TransactionsGetModel transaction, DebtDetailsController controller) {
  final formattedDate = dateP.DateFormat('dd/MM/yy HH:mm')
